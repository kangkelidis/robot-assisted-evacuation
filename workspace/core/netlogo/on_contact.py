...
def main() -> None:
    ...
    try:
        ...
        parser.add_argument("helper_gender", type=str)
        parser.add_argument("helper_culture", type=str)
        parser.add_argument("helper_age", type=str)
        parser.add_argument("fallen_gender", type=str)
        parser.add_argument("fallen_culture", type=str)
        parser.add_argument("fallen_age", type=str)
        parser.add_argument("helper_fallen_distance", type=str)
        parser.add_argument("staff_fallen_distance", type=str)
        arguments = parser.parse_args()

        candidate_helper = Survivor(arguments.helper_gender, arguments.helper_culture,
                                    arguments.helper_age)
        victim = Survivor(arguments.fallen_gender, arguments.fallen_culture,
                          arguments.fallen_age)
        helper_victim_distance: str = arguments.helper_fallen_distance
        first_responder_victim_distance: str = arguments.staff_fallen_distance
        simulation_id: str = arguments.simulation_id
        ...
        logger.error(f"Error in on_survivor_contact: {e}")
        sys.exit(1)
